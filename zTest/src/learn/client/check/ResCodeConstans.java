...
public class ResCodeConstans {
	...
	public final static String limitNumbers = "-89"; // 操作次数达到限制

	public final static String passwordError = "-90"; // 密码错误

	public final static String dataExist = "-91"; // 数据已存在，数据重复

	public final static String unsupportedBusiness = "-92"; // 不支持的业务或者类型

	public final static String rsaError = "-93"; // RSA或者其它解密失败
