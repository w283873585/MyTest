 ...
 * @author 易茂剑
 */
public abstract class VR_Coder {
	 ...
	 * </pre>
	 */
	protected static final String KEY_MAC = "HmacMD5";
	 ...
	 * @throws Exception
	 */
	protected static byte[] encryptMD5(byte[] data) throws Exception {
